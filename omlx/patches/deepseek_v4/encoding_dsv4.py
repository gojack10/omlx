...
#
# Vendored verbatim from deepseek-ai/DeepSeek-V4-Flash-JANGTQ
# (HuggingFace repo, file: encoding/encoding_dsv4.py, commit cac26cf3…,
# blob cdb68f23…, retrieved 2026-05-04). The model publisher ships this
# as the "self-contained reference implementation" of the V4 prompt
# encoding, so it is the authoritative training-format spec.
#
# MIT License — Copyright (c) 2023 DeepSeek. Full notice in the sibling
# file LICENSE-encoding_dsv4.
#
# Do NOT edit this file in place: omlx-specific behaviour (mlx-lm
# apply_chat_template signature, dict-typed tool_call arguments from the
# Anthropic adapter, etc.) is layered on in chat_template_v4.py. Keeping
# this file byte-identical to the upstream lets us re-pull future
# revisions with a single `cp`.
